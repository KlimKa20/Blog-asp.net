...
namespace WebApplication4.Migrations
{
    ...
    [Migration("20200921195913_InitialCreate111")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("blog_project.Models.Tag", b =>
                {
                    b.Property<int>("TagID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("blog_project.Models.Profile", null)
                        .WithMany()
            ...
            modelBuilder.Entity("blog_project.Models.Article", b =>
                {
                    ...
                    b.HasOne("blog_project.Models.Tag", "Tag")
                        .WithMany("Articles")
                        .HasForeignKey("TagID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
